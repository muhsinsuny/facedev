...
//     if (!user) return;
//     try {
//       let uploadedImage: string | File = image;
//       if (image instanceof File) {
//         // if you need to upload file to server directly, handle in backend
//         uploadedImage = image;
//       }
...
//           uploadedImage instanceof File ? undefined : uploadedImage
//         );
//         navigate('/');
//       }
//     } catch (err) {
...
//             <Button
//               className='bg-primary-300 hover:bg-primary-200 right-0 h-[44px] w-[265px] cursor-pointer rounded-full text-white hover:text-black'
